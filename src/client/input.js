...
window.addEventListener('mousemove', function (event) {
	...
	input.mouse.direction = Math.atan2(event.clientY - window.innerHeight / 2, event.clientX - window.innerWidth / 2);
});

//window.addEventListener('click', function (event) {
	//TODO:
	//userInput.mouse.isClicked = true;
//});

//window.addEventListener('buttons', function (event) {
	//TODO: Update mouse buttons state
//});